...
portal_source_username = os.environ['ARCGIS_SOURCE_PORTAL_PROD_USERNAME']
portal_source_password = os.environ['ARCGIS_SOURCE_PORTAL_PROD_PASSWORD']
ags_source_username = os.environ['ARCGIS_SOURCE_SERVER_USERNAME']
ags_source_password = os.environ['ARCGIS_SOURCE_SERVER_PASSWORD']

portal_target_url = ''
portal_source_url = os.environ['ARCGIS_ENTERPRISE_SOURCE_PROD_URL']
